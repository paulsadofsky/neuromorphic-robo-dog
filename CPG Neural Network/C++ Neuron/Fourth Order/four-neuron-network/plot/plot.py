...
df = pd.read_csv('CPG Neural Network/C++ Neuron/Fourth Order/four-neuron-network-weighted/network-membrane-voltage.csv')
...
plt.savefig('CPG Neural Network/C++ Neuron/Fourth Order/four-neuron-network-weighted/plot/network-plot.png')